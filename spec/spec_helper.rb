...
Spork.prefork do
  ...
  #Issue: https://groups.google.com/forum/#!topic/ruby-capybara/Kx_lpVAPiRg
  ...
  RSpec.configure do |config|
    ...
    # look for request type tests in the spec/API folder
    config.include RSpec::Rails::RequestExampleGroup, type: :model, example_group: {
      file_path: /spec\/presenter/
    }
  end
